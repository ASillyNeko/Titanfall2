global function SP_SEWERS1_AutoPrecache

void function SP_SEWERS1_AutoPrecache()
{
#if DEV
	#if SERVER
	SetAutoPrecacheVersion( 5 )
	// NPC spawners found:
	AP_NPCSpawnerFound( "npc_drone_beam", 2 )
	AP_NPCSpawnerFound( "npc_drone_plasma", 4 )
	AP_NPCSpawnerFound( "npc_drone_worker", 3 )
	AP_NPCSpawnerFound( "npc_dropship", 7 )
	AP_NPCSpawnerFound( "npc_soldier", 123 )
	AP_NPCSpawnerFound( "npc_spectre", 7 )
	AP_NPCSpawnerFound( "npc_stalker", 15 )
	AP_NPCSpawnerFound( "npc_titan_atlas_tracker", 8 )
	AP_NPCSpawnerFound( "npc_titan_ogre_meteor", 1 )
	AP_NPCSpawnerFound( "npc_titan_stryder_rocketeer", 4 )
	AP_NPCSpawnerFound( "npc_turret_sentry", 1 )
	#endif

	AP_PrecacheWeapon( "melee_pilot_emptyhanded", 1 )
	AP_PrecacheWeapon( "melee_titan_punch", 7 )
	...
	AP_PrecacheWeapon( "melee_titan_punch_tone", 10 )
	...
	AP_PrecacheWeapon( "mp_titanability_hover", 7 )
	AP_PrecacheWeapon( "mp_titanability_laser_trip", 1 )
	AP_PrecacheWeapon( "mp_titanability_particle_wall", 10 )
	...
	AP_PrecacheWeapon( "mp_titanability_sonar_pulse", 10 )
	...
	AP_PrecacheWeapon( "mp_titancore_flight_core", 7 )
	AP_PrecacheWeapon( "mp_titancore_laser_cannon", 1 )
	AP_PrecacheWeapon( "mp_titancore_salvo_core", 10 )
	...
	AP_PrecacheWeapon( "mp_titanweapon_shoulder_rockets", 7 )
	AP_PrecacheWeapon( "mp_titanweapon_sniper", 1 )
	AP_PrecacheWeapon( "mp_titanweapon_sticky_40mm", 11 )
	AP_PrecacheWeapon( "mp_titanweapon_tracker_rockets", 10 )
	AP_PrecacheWeapon( "mp_titanweapon_vortex_shield", 7 )
	AP_PrecacheWeapon( "mp_titanweapon_vortex_shield_ion", 1 )
	AP_PrecacheWeapon( "mp_titanweapon_xo16_shorty", 1 )
	AP_PrecacheWeapon( "mp_weapon_alternator_smg", 2 )
	...
	AP_PrecacheWeapon( "mp_weapon_thermite_grenade", 72 )
	AP_PrecacheWeapon( "mp_weapon_yh803_bullet", 1 )
