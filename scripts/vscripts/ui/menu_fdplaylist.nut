...
void function InitFDPlaylistMenu()
{
	...
	//	file.hostButton = Hud_GetChild( file.menu, "HostButton" )
//	AddButtonEventHandler( file.hostButton, UIE_CLICK, OnHostButtonClick )
//	AddButtonEventHandler( file.hostButton, UIE_GET_FOCUS, OnHostButtonFocus )
//	AddButtonEventHandler( file.hostButton, UIE_LOSE_FOCUS, OnHostButtonFocusLost )
...
//	pbRui = Hud_GetRui( file.hostButton )
//	RuiSetBool( pbRui, "bigPresentation", false )
//	RuiSetImage( pbRui, "itemImage", GetPlaylistImage( "lts" ) )
//	RuiSetString( pbRui, "title", "#FD_HOST_BUTTON" )
...
void function OnPlayButtonClick( var button )
{
	...
	string playlistsCS = ConvertStringArrayToCSS( selectedDifficulties )
	printt( "Setting match_playlist to '" + playlistsCS + "' from FD menu" )
