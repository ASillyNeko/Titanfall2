...
void function InitGammaMenu()
{
	...
	AddMenuFooterOption( menu, BUTTON_A, "#A_BUTTON_SET_BRIGHTNESS" )
...
void function OnGammaMenu_Open()
{
	...
	RegisterStickMovedCallback( ANALOG_LEFT_X, OnStickMoved )
	...
	DeregisterStickMovedCallback( ANALOG_LEFT_X, OnStickMoved )
}
